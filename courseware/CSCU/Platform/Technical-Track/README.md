...
| `05-Visualizations` | **PDC Insights** | The suite's dashboard app (installed by the PDC-Demo bootstrap, port 5002): 18 built-in dashboards over the governance APIs + the AI Builder |
