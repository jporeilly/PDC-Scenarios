...
DOCS = [
 ("Platform/Workshop-00-Preflight/Workshop-00-Guide.md", "Platform/Workshop-00-Preflight/Workshop-00-Guide.docx",
  dict(eyebrow1=E1, eyebrow2="PDC PROCESS  ·  USERS & ROLES", label="WORKSHOP 0",
       title="Preflight: Provision Users & Roles",
       subtitle="Build the CSCU cast — nine users across all seven PDC roles — so every later action lands on a named, least-privilege account.",
       meta=[("Primary role", "IT Administrator / Catalog Admin"), ("Estimated time", "20 minutes"),
             ("Dataset", "Copper State Credit Union (users.csv)")],
       header="Workshop 0: Preflight — Users & Roles")),
 ("Platform/Workshop-01-Connect-Data-Sources/Workshop-01-Guide.md", "Platform/Workshop-01-Connect-Data-Sources/Workshop-01-Guide.docx",
  dict(eyebrow1=E1, eyebrow2="PDC PROCESS  ·  METADATA INGEST", label="WORKSHOP 1",
       title="Connect the Data Sources",
       subtitle="Bring the Copper State Credit Union database and document store under catalog governance.",
 ...
 ("Platform/Workshop-02-Structure-and-Metadata/Workshop-02-Guide.md", "Platform/Workshop-02-Structure-and-Metadata/Workshop-02-Guide.docx",
 ...
 ("Platform/Workshop-03-Glossary-Terms/Workshop-03-Guide.md", "Platform/Workshop-03-Glossary-Terms/Workshop-03-Guide.docx",
 ...
 ("Platform/Workshop-04-Profiling-and-Quality/Workshop-04-Guide.md", "Platform/Workshop-04-Profiling-and-Quality/Workshop-04-Guide.docx",
 ...
 ("Platform/Workshop-05-Data-Identification/Workshop-05-Guide.md", "Platform/Workshop-05-Data-Identification/Workshop-05-Guide.docx",
 ...
 ("Glossary/Workshop-Glossary-Generator-CSCU.md", "Glossary/Workshop-Glossary-Generator-CSCU.docx",
  dict(eyebrow1=E1T, eyebrow2="PDC PROCESS  ·  GLOSSARY GENERATOR", label="APP WORKSHOP",
       title="Build the Glossary with the Glossary Generator",
       subtitle="Scan, review, govern and apply CSCU's governed glossary — and author the Registry — with the app.",
       meta=[("Primary role", "Data Steward / Solution Architect"), ("Estimated time", "60–90 minutes"),
             ("Dataset", DS)],
       header="App Workshop: Glossary Generator",
       embeds={"2. What you will build": ("rId101", "two-apps", TWO_APPS),
               "5. Where the story continues": ("rId102", "registry-spine", SPINE)})),
 ("Platform/Technical-Track/02-Data-Identification/Data-Identification-Guide.md",
  "Platform/Technical-Track/02-Data-Identification/Data-Identification-Guide.docx",
  dict(eyebrow1=E1T, eyebrow2="PDC PROCESS  ·  DATA IDENTIFICATION", label="MODULE 02",
       title="Data Identification: the Engine",
       subtitle="How dictionaries and patterns combine into policies that tag CSCU's data — and where the steward takes over.",
       meta=[("Primary role", "Data Steward / Data Developer / Admin"), ("Estimated time", "45 minutes"),
             ("Dataset", DS)],
       header="Technical Track — Module 02: Data Identification",
       embeds={"5. Where the steward fits": ("rId101", "challenge-and-goal", CHALLENGE)})),
 ("Platform/Technical-Track/03-Build-Your-Own-Dictionary-and-Pattern/Lab-Build-Your-Own-CSCU-Dictionary-and-Pattern.md",
  "Platform/Technical-Track/03-Build-Your-Own-Dictionary-and-Pattern/Lab-Build-Your-Own-CSCU-Dictionary-and-Pattern.docx",
  dict(eyebrow1=E1T, eyebrow2="PDC PROCESS  ·  DATA IDENTIFICATION", label="MODULE 03 · LAB",
       title="Build Your Own Dictionary & Pattern",
       subtitle="Author a CSCU dictionary and a pattern, combine them into a policy, and run it on the banking data.",
       meta=[("Primary role", "Data Steward / Data Storage Administrator"), ("Estimated time", "45 minutes"),
             ("Dataset", DS)],
       header="Technical Track — Module 03: Build Your Own")),
 ("Platform/Technical-Track/04-Similarity & ML/Similarity-ML-Inference-Guide.md",
  "Platform/Technical-Track/04-Similarity & ML/Similarity-ML-Inference-Guide.docx",
  dict(eyebrow1=E1T, eyebrow2="PDC PROCESS  ·  SIMILARITY & ML", label="MODULE 04",
       title="Similarity & ML Inference",
       subtitle="Propagate steward curation to similar columns — and know when not to.",
       meta=[("Primary role", "Data Steward / Data Developer"), ("Estimated time", "30 minutes"),
             ("Dataset", DS)],
