...
CW = os.path.join(ROOT, "courseware", "MFG")
...
DS = "Cascade Precision Components (cpc_mfg + cpc-documents)"
...
DOCS = [
 ("Platform/Workshop-00-Preflight/Workshop-00-Guide.md", "Platform/Workshop-00-Preflight/Workshop-00-Guide.docx",
  dict(eyebrow1=E1, eyebrow2="PDC PROCESS  ·  USERS & ROLES", label="WORKSHOP 0",
       ...
       subtitle="Build the CPC cast — nine users across all seven PDC roles — so every later action lands on a named, least-privilege account.",
       meta=[("Primary role", "IT Administrator / Catalog Admin"), ("Estimated time", "20 minutes"),
             ("Dataset", "Cascade Precision Components (users.csv)")],
 ...
 ("Platform/Workshop-01-Connect-Data-Sources/Workshop-01-Guide.md", "Platform/Workshop-01-Connect-Data-Sources/Workshop-01-Guide.docx",
  dict(eyebrow1=E1, eyebrow2="PDC PROCESS  ·  METADATA INGEST", label="WORKSHOP 1",
       ...
       subtitle="Bring the Cascade Precision Components manufacturing database and document store under catalog governance.",
 ...
 ("Platform/Workshop-03-Glossary-Terms/Workshop-03-Guide.md", "Platform/Workshop-03-Glossary-Terms/Workshop-03-Guide.docx",
  dict(eyebrow1=E1, eyebrow2="PDC PROCESS  ·  BUSINESS GLOSSARY", label="WORKSHOP 3",
       ...
       subtitle="Give CPC one governed vocabulary: build, import, link and steward the terms — then feed each table's Trust Score.",
 ...
 ("Platform/Workshop-04-Profiling-and-Quality/Workshop-04-Guide.md", "Platform/Workshop-04-Profiling-and-Quality/Workshop-04-Guide.docx",
  dict(eyebrow1=E1, eyebrow2="PDC PROCESS  ·  PROFILING & QUALITY", label="WORKSHOP 4",
       ...
       subtitle="Profile CPC's tables to generate statistics, discover keys, make the Trust Score real — and score the quality-system obligations as business rules.",
 ...
 ("Platform/Workshop-05-Data-Identification/Workshop-05-Guide.md", "Platform/Workshop-05-Data-Identification/Workshop-05-Guide.docx",
  dict(eyebrow1=E1, eyebrow2="PDC PROCESS  ·  DATA IDENTIFICATION", label="WORKSHOP 5",
       ...
       subtitle="How PDC recognizes what your data is — and why an estate with almost no PII still needs a full custom method library.",
       meta=[("Primary role", "Business Analyst"), ("Estimated time", "60 minutes"), ("Dataset", DS)],
...
print("ALL BUILT (MFG)" + (" (filtered: %s)" % ",".join(FILTERS) if FILTERS else ""))
